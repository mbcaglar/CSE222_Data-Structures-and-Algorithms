...
public class BinarySearchTree<E extends Comparable<E>>  implements Iterable<E>{
  ...
  private ArrayDeque<Node> queue = new ArrayDeque<>();  
   ...
   public void remove() {  
    ...
    public BinarySearchTree<String> readBinaryTree(Scanner scan)throws NoSuchElementException{
    ...
    /*
    public BinarySearchTree<String> readBinaryTree(Scanner scan){
        
        return readBinaryTree(scan,root);
    }
    
    public BinarySearchTree<String> readBinaryTree(Scanner scan,Node root){
    ...
    public BinarySearchTree<E> getRighttSubtree(){
